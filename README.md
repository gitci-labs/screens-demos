...
- `demos/reader-immersive`: a reading/study app scene set with target-specific feature closeups, English/Japanese localized copy, and Fastlane export coverage.
